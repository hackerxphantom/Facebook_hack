    ...
    def updateFacebook_hack():
        ...
        if repoVersion == currentVersion:write("  [*] The script is up to date!\n")
                ...
                with open("facebook_hack.py", "w") as  facebook_hackScript:
                   facebookhackScript.write(newCode)
...
def Main():
   ...
   if update:
    ...
    sys.exit(1)
        ...
        facebook_hack.banner(target,wordlist,single_passwd)
        ...
        for passwd in passwords:
                ...
                retCode = facebook_hack.login(target, passwd)
                if retCode:
